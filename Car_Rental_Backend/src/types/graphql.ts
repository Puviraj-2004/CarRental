...
// Legacy context alias (prefer the full interface above)
export interface GraphQLContextLegacy {
  userId?: string;
  role?: Role;
  loaders: DataLoaders;
}
...
// ─── Pagination Types ────────────────────────────────────────────────
export { PaginationInput, PageInfo, PaginatedResult } from '../utils/pagination';
...
export interface CarQueryArgs extends BaseArgs {
  ...
  pagination?: import('../utils/pagination').PaginationInput;
}
