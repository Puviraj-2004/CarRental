...
export default function FeaturedFleet({ cars, loading, error, t }: FeaturedFleetProps) {
                ...
                >
                  ...
                  <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 3, mt: 'auto', px: 1 }}>
                    ...
                    <Stack direction="row" spacing={0.5} alignItems="center" color="#64748B">
                      ...
                      <Typography variant="caption" fontWeight={600}>{car.seats} {t('home.people')}</Typography>
                    </Stack>
                  </Stack>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box>
                      <Typography variant="h6" fontWeight={800} color="#0F172A">
                        ...
                        <Typography component="span" variant="caption" color="#64748B" sx={{ ml: 0.5 }}>{t('home.perDay')}</Typography>
                      </Typography>
                    </Box>
                    <Button 
                      variant="contained" 
