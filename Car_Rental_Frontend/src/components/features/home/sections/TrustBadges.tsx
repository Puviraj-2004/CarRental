...
export default function TrustBadges({ t }: TrustBadgesProps) {
  const items = [
    { 
      icon: <MonetizationOnIcon />, 
      title: t('home.transparentPricing'), 
      desc: t('home.transparentPricingDesc')
    },
    { 
    ...
    { 
      ...
      title: t('home.aiAvailability'), // Changed Title
      desc: t('home.aiAvailabilityDesc') // Changed Description
    }
  ];
