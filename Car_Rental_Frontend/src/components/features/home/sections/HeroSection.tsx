    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
        ...
        <Box sx={{ mb: 6, maxWidth: '850px', mx: 'auto' }}>
          ...
          >
            {t('home.driveYourDream')} <br />
            <Box component="span" sx={{ color: '#ffffffff' }}>{t('home.anytimeAnywhere')}</Box>
          </Typography>
        </Box>
        ...
        >
          ...
          >
            ...
            <Typography sx={{ display: { xs: 'inline', md: 'none' }, ml: 1, fontWeight: 700 }}>{t('home.searchCars')}</Typography>
          </Button>
        </Paper>
