...
export const InventoryContainer = () => {
  ...
  const handleAdd = async () => {
    try {
      ...
      setNewName('');
      setAlert({ open: true, msg: t('containerMessages.entryAdded'), severity: 'success' });
    } catch (e: any) { setAlert({ open: true, msg: getSafeErrorMessage(e, t('errors.generic')), severity: 'error' }); }
  };
  ...
  const handleUpdate = async () => {
    try {
      ...
      setEditOpen(false);
      setAlert({ open: true, msg: t('containerMessages.updatedSuccessfully'), severity: 'success' });
    } catch (e: any) { setAlert({ open: true, msg: getSafeErrorMessage(e, t('errors.generic')), severity: 'error' }); }
  };
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      setDeleteOpen(false);
      setAlert({ open: true, msg: t('containerMessages.deletedSuccessfully'), severity: 'warning' });
    } catch (e: any) { 
